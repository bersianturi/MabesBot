module.exports = {
  ...
  adminId: "425636986452443137", //- Replace UserId with the Discord ID of the admin of the bot
  ...
  website: "https://mabesbot.cyclic.app:3000", //- without the / at the end
  // You need a lavalink server for this bot to work!!!!
  // Lavalink server; public lavalink -> https://lavalink-list.darrennathanael.com/; create one yourself -> https://darrennathanael.com/post/how-to-lavalink
  nodes: [
    {
      identifier: "Main Node", //- Used for indentifier in stats commands.
      host: "lavalink.teramont.net", //- The host name or IP of the lavalink server.
      port: 443, // The port that lavalink is listening to. This must be a number!
      password: "eHKuFcz67k4lBS64", //- The password of the lavalink server.
  ...
  presence: {
    ...
    activities: [
      {
        name: "Info makan besar!", //- Status Text
        type: "LISTENING", //- PLAYING, WATCHING, LISTENING, STREAMING
      },
    ],
  },
  iconURL:
    "https://cdn.discordapp.com/attachments/1130147650021359627/1202990645208416326/mabes-rectangle.png", //- This icon will be in every embed's author field
};
